...
public class ModelFireBattleMage extends ModelBiped {
	...
	public ModelFireBattleMage(boolean legs) {
		...
		cube_r1.setRotationPoint(3.0F, -7.5F, 6.5F);
		...
		cube_r2.setRotationPoint(2.0F, -7.5F, 4.5F);
		...
		cube_r3.setRotationPoint(-2.0F, -7.5F, 4.5F);
		...
		cube_r4.setRotationPoint(-3.0F, -7.5F, 6.5F);
