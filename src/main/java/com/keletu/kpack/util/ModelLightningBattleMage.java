...
public class ModelLightningBattleMage extends ModelBiped {
	...
	public ModelLightningBattleMage(boolean legs) {
		...
		head8_r1.setRotationPoint(3.6F, 0.6F, 9.8F);
		helmet.addChild(head8_r1);
		setRotationAngle(head8_r1, -0.1352F, 0.3059F, -0.0119F);
		head8_r1.cubeList.add(new ModelBox(head8_r1, 0, 0, -1.0F, -1.0F, -2.5F, 2, 2, 6, 0.0F, false));
		...
		head8_r2.setRotationPoint(-3.6F, -1.8F, 9.8F);
		helmet.addChild(head8_r2);
		setRotationAngle(head8_r2, 0.0829F, -0.3059F, 0.0119F);
		head8_r2.cubeList.add(new ModelBox(head8_r2, 0, 0, -1.0F, -1.0F, -2.5F, 2, 2, 6, 0.0F, true));

		head6_r1 = new ModelRenderer(this);
		head6_r1.setRotationPoint(5.1F, -6.5F, 14.2F);
		...
		cube_r1.setRotationPoint(1.0F, -0.8F, 11.5F);
		...
		cube_r2.setRotationPoint(1.7F, -4.8F, 11.5F);
		...
		cube_r3.setRotationPoint(1.0F, -7.5F, 10.5F);
		helmet.addChild(cube_r3);
		setRotationAngle(cube_r3, -0.6519F, 0.1197F, 0.0301F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, true));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(2.0F, -7.5F, 6.5F);
		helmet.addChild(cube_r4);
		setRotationAngle(cube_r4, -0.4169F, 0.1983F, 0.1361F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, true));

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(5.3F, -2.6F, 8.1F);
		...
		cube_r6.setRotationPoint(-1.0F, -0.8F, 11.5F);
		...
		cube_r7.setRotationPoint(-1.7F, -4.8F, 11.5F);
