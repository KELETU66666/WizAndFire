...
public class ModelIceSageArmor extends ModelArmorStandFixed {
	...
	public ModelIceSageArmor(boolean legs) {
		textureWidth = 128;
		textureHeight = 64;
		...
		helmet.cubeList.add(new ModelBox(helmet, 64, 4, -5.4F, -7.0F, 14.4F, 1, 3, 1, 0.0F, false));
		...
		cube_r1.setRotationPoint(-7.9F, -19.5F, 3.3F);
		armr.addChild(cube_r1);
		setRotationAngle(cube_r1, -1.4835F, -0.48F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-8.5F, -17.5F, 2.9F);
		...
		cube_r4.setRotationPoint(-7.0F, -25.5F, 2.0F);
		...
		cube_r5.setRotationPoint(-7.0F, -23.5F, 3.0F);
		...
		cube_r7.setRotationPoint(8.5F, -17.5F, 2.9F);
		...
		cube_r8.setRotationPoint(7.5F, -21.5F, 3.3F);
		arml.addChild(cube_r8);
		setRotationAngle(cube_r8, -1.2654F, 0.1745F, 0.0F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, true));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(7.0F, -25.5F, 2.0F);
		...
		cube_r10.setRotationPoint(7.0F, -23.5F, 3.0F);
		...
		ChestClothR_r2.setRotationPoint(-0.4F, -13.3F, -3.5F);
		torso.addChild(ChestClothR_r2);
		setRotationAngle(ChestClothR_r2, -0.0436F, 0.0F, 0.0F);
		ChestClothR_r2.cubeList.add(new ModelBox(ChestClothR_r2, 75, 45, -0.5F, -4.5F, -0.5F, 2, 9, 1, 0.0F, true));
		...
		ll6_r1.setRotationPoint(-5.6F, -1.6F, 4.7F);
		legr.addChild(ll6_r1);
		setRotationAngle(ll6_r1, 0.0F, 0.3491F, -0.0175F);
		ll6_r1.cubeList.add(new ModelBox(ll6_r1, 86, 36, -1.0F, -2.5F, -2.0F, 2, 5, 4, 0.0F, false));

		ll5_r2 = new ModelRenderer(this);
		ll5_r2.setRotationPoint(-5.6F, -1.6F, 0.8F);
		legr.addChild(ll5_r2);
		setRotationAngle(ll5_r2, 0.0F, -0.3665F, 0.0873F);
