...
public class ModelFireMageArmor extends ModelArmorStandFixed {
	...
	public ModelFireMageArmor(boolean legs) {
		...
		cube_r1.setRotationPoint(-9.0F, -19.5F, 2.0F);
		armr.addChild(cube_r1);
		setRotationAngle(cube_r1, -0.5672F, -0.0873F, -0.7418F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-9.0F, -21.5F, 2.0F);
		armr.addChild(cube_r2);
		setRotationAngle(cube_r2, -0.5672F, -0.0873F, -0.7418F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(-9.0F, -23.5F, 2.0F);
