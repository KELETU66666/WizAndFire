...
public class ModelLightningMageArmor extends ModelArmorStandFixed {
	...
	private final ModelRenderer Book_r2;
	...
	public ModelLightningMageArmor(boolean legs) {
		textureWidth = 128;
		textureHeight = 64;
		...
		cube_r1.setRotationPoint(-9.0F, -16.5F, 3.0F);
		...
		cube_r2.setRotationPoint(-9.0F, -20.5F, 3.0F);
		arml.addChild(cube_r2);
		...
		cube_r6.setRotationPoint(6.0F, -18.5F, 3.0F);
		arml.addChild(cube_r6);
		setRotationAngle(cube_r6, -1.0899F, -0.1064F, -0.1007F);
		cube_r6.cubeList.add(new ModelBox(cube_r6, 32, 18, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, true));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(6.0F, -21.5F, 3.0F);
		...
		cube_r9.setRotationPoint(9.0F, -20.5F, 3.0F);
		...
		cube_r10.setRotationPoint(9.0F, -23.5F, 3.0F);
		arml.addChild(cube_r10);
		setRotationAngle(cube_r10, -1.0289F, 0.4695F, 0.2206F);
		...
		Book_r1.setRotationPoint(5.4F, -0.5F, 2.2F);
		legl.addChild(Book_r1);
		...
		Book_r2 = new ModelRenderer(this);
		Book_r2.setRotationPoint(-5.6F, -1.0F, 2.2F);
		legr.addChild(Book_r2);
		setRotationAngle(Book_r2, -0.0873F, 0.0F, 0.0F);
		Book_r2.cubeList.add(new ModelBox(Book_r2, 110, 41, -1.0F, -2.5F, -3.5F, 2, 5, 7, 0.0F, false));
