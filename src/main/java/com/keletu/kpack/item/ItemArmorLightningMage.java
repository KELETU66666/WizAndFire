...
public class ItemArmorLightningMage extends ItemArmor {
    public final EntityEquipmentSlot slot;

    public ItemArmorLightningMage(String name, EntityEquipmentSlot slot) {
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _deafult) {
        return new ModelLightningMageArmor(
