...
public class ItemArmorDragonSage extends ItemWizardArmorSpecial {
    ...
    public ItemArmorDragonSage(String name, ArmorMaterial material, int renderIndex, EntityEquipmentSlot slot, int type) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        switch (this.type) {
            case 1:
                return "wizandfire:textures/models/armor/texture_sage_ice.png";
            case 2:
                return "wizandfire:textures/models/armor/" + (WizAndFireConfig.diamondLightning ? "diamond_sage_lightning.png": "texture_sage_lightning.png");
            default:
                return "wizandfire:textures/models/armor/texture_sage_fire.png";
        }
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _deafult) {
        return WizAndFire.proxy.getSageModel().get(this);
    }
}
