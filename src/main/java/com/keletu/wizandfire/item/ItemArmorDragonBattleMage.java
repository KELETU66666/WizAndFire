...
public class ItemArmorDragonBattleMage extends ItemWizardArmorSpecial {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        switch (this.type) {
            case 1:
                return "wizandfire:textures/models/armor/texture_battlemage_ice.png";
            case 2:
                return "wizandfire:textures/models/armor/" + (WizAndFireConfig.diamondLightning ? "diamond_battlemage_lightning.png": "texture_battlemage_lightning.png");
            default:
                return "wizandfire:textures/models/armor/texture_battlemage_fire.png";
        }
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _deafult) {
        return WizAndFire.proxy.getBattlemageModel().get(this);
    }
}
